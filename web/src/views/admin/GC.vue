    ...
    <div class="gc-actions-row">
      ...
      <section class="gc-main-card">
        ...
        <div class="candidate-list">
          <el-table v-if="candidates.length > 0" :data="candidates" max-height="240" class="modern-table small">
          ...
          <el-empty v-else :image-size="60" :description="t('gc.dryRunHint')" />
        </div>
      </section>
    ...
    <section class="gc-instructions-section">
      ...
      <el-collapse class="modern-collapse">
        <el-collapse-item :title="t('gc.whatIsGC')" name="1">
          <p>{{ t('gc.gcDescription') }}</p>
        </el-collapse-item>
        <el-collapse-item :title="t('gc.runGC')" name="4">
          <p>Automate via Cron Job:</p>
...
.gc-card-header h3 { font-size: 18px; font-weight: 700; margin: 0; }

.gc-form { margin-bottom: 24px; }
